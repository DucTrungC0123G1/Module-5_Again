        ...
        <>
            ...
            <div className="container px-5 my-5">
                <div>
                    ...
                    <input className="form-control" id="title" name="title" value={title}
                           onChange={(event) => handleInputTitle(event.target.value)}/>
                </div>
                <div>
                    <label htmlFor='category'>Input category</label>

                    <input className="form-control" id="category" name="category" value={category}
                           onChange={(event) => handleInputCategory(event.target.value)}/>
                </div>
                <div>
                    <label htmlFor='content'>Input content</label>

                    <input className="form-control" id="content" name="content" value={content}
                           onChange={(event) => handleInputContent(event.target.value)}/>
                </div>
